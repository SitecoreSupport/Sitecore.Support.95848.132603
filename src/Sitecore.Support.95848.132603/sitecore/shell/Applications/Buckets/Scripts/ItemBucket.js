                                                ...
                                                if (splitMe == undefined) {
                                                    ...
                                                    switch (window.currentBucketsViewType) {
                                                        ...
                                                        default:
                                                            ...
                                                            // Begin of Sitecore.Support.95848.132603
                                                            click = 'scForm.getParentForm().postRequest(\'\',\'\',\'\',\'contenteditor:launchtab(url=' + splitMe[1] + la + ')\'); return false;';
                                                            // End of Sitecore.Support.95848.132603
                                                            e += template.scFormat(click, id, innerHTML, title);
                                                    }
                                                }
